      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Your premier destination for quality clothing across all categories. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products?category=kids" className="text-gray-400 hover:text-white transition-colors">
                  Kids' Clothing
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">info@clothingstore.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 ClothingStore. All rights reserved.
          </p>
